...
class HirePost(models.Model):
    ...
    hire_post_title = models.CharField(max_length=255)
    hire_post_description = models.TextField(max_length=2000)
...
class JobPost(HirePost):
    ...
    job_position = models.CharField(max_length=50, choices=JOB_TYPE)
